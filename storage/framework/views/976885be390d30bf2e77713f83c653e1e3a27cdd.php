{
  ...
  "REGISTRATION_SAFETY": "Welcome to <?php echo e($chocolatey->hotelName); ?>! Have fun and <a href=\"/playing-habbo/safety\" target=\"_blank\">stay safe</a>!",
  ...
  "OK_BUTTON": "OK",
  "PHOTOS_TITLE": "Photos from <?php echo e($chocolatey->hotelName); ?>",
  ...
  "LOCAL_REGISTER_BANNER_FI": "Liity suomenkieliseen <?php echo e($chocolatey->hotelName); ?>on osoitteessa",
  "SHOP_CREDIT_CARD_CVC": "Security code",
  "USER_AVATAR_BAN_TEXT_WITH_GUIDE": "Your avatar <b>{{avatarName}}</b> has been banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?php echo e($chocolatey->hotelName); ?> Helpdesk</a>.</p>",
  ...
  "LOCAL_REGISTER_BANNER_IT": "Unisciti alla Community di <?php echo e($chocolatey->hotelName); ?> su",
  "ERROR_PASSWORD_MIN_LENGTH": "Too weak, you need to make it longer. Password has to be at least 6 character long.",
  "USER_IDENTITY_BAN_TEXT_WITH_GUIDE": "You have been banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?php echo e($chocolatey->hotelName); ?> Helpdesk</a>.</p>",
  ...
  "FOLLOW_HABBO": "Follow <?php echo e($chocolatey->hotelName); ?>",
  ...
  "FOOTER_ADVERTISERS": "<?php echo e($mail->from->address); ?>",
  ...
  "COMMUNITY_HABBO15_TAB": "<?php echo e($chocolatey->hotelName); ?> 15",
  ...
  "PROFILE_JOINED": "Joined <?php echo e($chocolatey->hotelName); ?> on {{date}}",
  ...
  "USER_IDENTITY_PERMANENT_BAN_TEXT_WITH_GUIDE": "You have been permanently banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?php echo e($chocolatey->hotelName); ?> Helpdesk</a>.</p>",
  "HEAD_TITLE_NOT_FOUND": "Not found",
  "SHOP_PAYMENT_DETAILS": "Check your details",
  "NAVIGATION_COMMUNITY": "Community",
  "EU_COOKIE_BANNER": "<?php echo e($chocolatey->hotelName); ?> uses its own and third-party cookies in order to provide a better service and display advertisement that fits your preferences. By using our website you agree to our cookie policy.",
  ...
  "LOCAL_REGISTER_BANNER_ES": "Únete a tu Comunidad <?php echo e($chocolatey->hotelName); ?> en",
  ...
  "PLAYING_HABBO_WHAT_IS_HABBO_TAB": "What is <?php echo e($chocolatey->hotelName); ?>?",
  "USER_AVATAR_PERMANENT_BAN_TEXT_WITH_GUIDE": "Your avatar <b>{{avatarName}}</b> has been banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?php echo e($chocolatey->hotelName); ?> Helpdesk</a>.</p>",
  ...
  "PHOTOS_DESCRIPTION": "Have a look at some of the great moments captured by <?php echo e($chocolatey->hotelName); ?>s around the hotel.",
  ...
  "PARTNER_REGISTRATION_HELP": "Want access to loads of free web games? Register this e-mail and password to <?php echo e($chocolatey->hotelName); ?>'s trusted partner <a href=\"https://www.idcgames.com\" target=\"_blank\">IDC/Games</a> at the same time!",
  "SHOP_PAYMENTMETHOD_SMALLPRINT_IT_BOKU_IT": "Standard text message fee will also be charged depending on operator and mobile phone plan. You will be charged for this purchase on your next phone bill. If you are on a prepaid balance, the sum will be subtracted from your balance immediately. The quoted price is charged for each SMS that is requested. <BR/> <BR/> \r\n\r\nPlease stay within the <A HREF=\"https://help.habbo.com/entries/347508-What-are-the-spending-limits-on-Habbo-\" TARGET=\"_blank\"> spending limits</A> listed on our Help pages.<BR/> <BR/> \r\n\r\nSMS payment service provided by Boku. If you need assistance with mobile purchases, please contact Boku customer service: <A HREF=\"mailto:support@boku.com\">support@boku.com</A>. <BR/> <BR/>",
  "LOCAL_REGISTER_BANNER_DE": "Schließe dich der <?php echo e($chocolatey->hotelName); ?> Community an in",
  ...
  "SETTINGS_OFFLINE_MESSAGING_ENABLED_DESCRIPTION": "If you use Pocket <?php echo e($chocolatey->hotelName); ?>, friends will always be able to send you private messages.",
  ...
  "NEW_USER_AGREEMENT_INFO_TEXT": "It's been a while since you logged in to <?php echo e($chocolatey->hotelName); ?>! Please review the latest version of our <a href=\"https://help.habbo.com/entries/23096348-Terms-of-Service-and-Privacy-Policy\" target=\"_blank\">Terms of Service, Privacy Policy and Cookie Policy</a>.",
  "READ_MORE": "Read more",
  ...
  "EMAIL_NEW_HELP": "You'll need to use this email address to log in to <?php echo e($chocolatey->hotelName); ?> in the future. Please use a valid address.",
  ...
  "ROOMS_DESCRIPTION": "Check out some of the most popular rooms within <?php echo e($chocolatey->hotelName); ?> right now!",
  "SHOP_INFO_TAB": "Mall Info",
  "SHOP_PAYMENTMETHOD_TITLE_ES_SMS_TIMWE_PE": "<B>SMS</B> (Movistar)",
  "REPORT_EXPLANATION": "Please tell us why you think this image should be removed from <?php echo e($chocolatey->hotelName); ?>.",
  ...
  "FOOTER_COPYRIGHT": "© {{year}} <?php echo e($chocolatey->hotelName); ?> Isn't a Trademark of Sulake Corporation Oy. This website hasn't any filiation with Sulake.",
  ...
  "EMAIL_REPORT_UNAUTHORIZED_SUCCESS": "Email address added to <?php echo e($chocolatey->hotelName); ?> block list.",
  ...
  "HEAD_TITLE_HABBO15": "<?php echo e($chocolatey->hotelName); ?> 15th birthday!",
  ...
  "SHOP_CREDIT_CARD_SMALLPRINT": "Credit card payment service provided by Adyen. <?php echo e($chocolatey->hotelName); ?> does not store your credit card information. If you need assistance with credit card purchases, please contact our <a href=\"https://help.habbo.com\">Customer Support</a>.",
  ...
  "MODERATION_MESSAGE_INSTRUCTIONS": "Please read the <a href=\"/playing-habbo/habbo-way\"><?php echo e($chocolatey->hotelName); ?> Way</a> to lean how to keep your photos classy!",
  "SHOP_PAYMENTMETHOD_SMALLPRINT_ES_SMS_TIMWE_DOR": "Standard text message fee will also be charged depending on operator and mobile phone plan. You will be charged for this purchase on your next phone bill. If you are on a prepaid balance, the sum will be subtracted from your balance immediately. The quoted price is charged for each SMS that is requested.<BR/> <BR/>\r\n\r\nThere is <A HREF=\"https://help.habbo.com/entries/347508-What-are-the-spending-limits-on-Habbo-\" TARGET=\"_blank\"> spending limit information</A> available on our Help pages. <BR/> <BR/>\r\n\r\nSMS payment service provided by PARTNER. If you need assistance with mobile purchases, please contact PARTNER CUSTOMER SERVICE CONTACT. <BR/> <BR/>",
  "FORM_NAME_LABEL": "<?php echo e($chocolatey->hotelName); ?> name",
  "SHOP_HISTORY_TAB": "My history",
  "POLICIES_MARKETING": "Keep me updated about the latest <?php echo e($chocolatey->hotelName); ?> happenings, news and gossip!",
  ...
  "NOT_FOUND_PAGE_TEXT": "Frank can't find the page you're looking for. Please check the URL or try starting over from the <a href=\"/\"><?php echo e($chocolatey->hotelName); ?> front page.</a>",
  ...
  "INTERS_DESCRIPTION": "Ads help keep <?php echo e($chocolatey->hotelName); ?> free!",
  ...
  "ACCOUNT_SECURITY_TRUSTED_LOCATIONS_DESCRIPTION": "We <b>won't ask safety questions for logins on trusted locations</b>. You can save a location as trusted when you log into <?php echo e($chocolatey->hotelName); ?> with a new device and a new IP address and answer the security questions correctly.<br><br>You should <b>reset your trusted locations if you have unlocked your <?php echo e($chocolatey->hotelName); ?> account on public computers</b> you no longer want to use.",
  ...
  "HEAD_TITLE_PLAYING_HABBO_WHAT_IS_HABBO": "What is <?php echo e($chocolatey->hotelName); ?>?",
  ...
  "HOTEL_CLOSED_DESCRIPTION": "Even pixel staff need their beauty sleep! The Hotel is currently closed, but will reopen again soon. Check out some of the amazing stuff on <?php echo e($chocolatey->hotelName); ?> while you wait:",
  "SHOP_SMALLPRINT_TITLE": "Important notice",
  "SETTINGS_ENABLE_NEWSLETTER_LABEL": "Yes! I want the latest <?php echo e($chocolatey->hotelName); ?> news sent straight to my e-mail inbox.",
  ...
  "FOOTER_ADVERTISERS_LINK": "mailto:<?php echo e($mail->from->address); ?>",
  ...
  "LIMIT_EXCEEDED": "Sorry, your payment couldn't be processed. Note that <?php echo e($chocolatey->hotelName); ?> has different spending limits for different payment options.\r\n\r\nPlease try again after a while, or use an alternative payment method. For further assistance, please refer to our Customer Support & Helpdesk pages.",
  ...
  "NEWS_CATEGORY_TECHNICAL_UPDATES": "<?php echo e($chocolatey->hotelName); ?> Updates",
  ...
  "SETTINGS_ENABLE_FRIEND_REQUESTS_LABEL": "Other <?php echo e($chocolatey->hotelName); ?>s can send me friend requests",
  ...
  "SHOP_CREDITS_DESCRIPTION": "Get {{value}} credits and {{value}} diamonds! You can use them in <?php echo e($chocolatey->hotelName); ?> Hotel to purchase all sorts of amazing things, like furni, pets and even <?php echo e($chocolatey->hotelName); ?> Club memberships!",
  ...
  "ERROR_EMAIL_REGISTRATION_USED": "The email you gave is already in use. If you're trying to create a new character, please log in with your <?php echo e($chocolatey->hotelName); ?> account and create a new character.",
  ...
  "LOGIN_RPX_REGISTRATION_DISABLED": "There is no <?php echo e($chocolatey->hotelName); ?> account connected to that Google, Twitter, Yahoo or Microsoft account. Please check your login or register a new <?php echo e($chocolatey->hotelName); ?> account with email or Facebook.",
  ...
  "MONTH_MARCH": "March",
  "LOCAL_REGISTER_BANNER_TR": "<?php echo e($chocolatey->hotelName); ?> Topluluğuna Katılın",
  ...
  "USER_AVATAR_PERMANENT_BAN_TEXT": "Your avatar <b>{{avatarName}}</b> has been banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>.",
  ...
  "HEAD_TITLE_NEWS": "<?php echo e($chocolatey->hotelName); ?> - Virtual World, Avatar Chat, and Pixel Art",
  "MONTH_APRIL": "April",
  "MONTH_JULY": "July",
  ...
  "ERROR_BIRTHDATE_AGE": "You are not eligible to register for <?php echo e($chocolatey->hotelName); ?>. Please check our Terms of Service.",
  "HEAD_TITLE_PLAYING_HABBO_HABBO_WAY": "<?php echo e($chocolatey->hotelName); ?> Way",
  ...
  "SHOP_DOUBLE_CREDITS_DESCRIPTION": "For a limited time only - get 2 x {{value}} credits and 2 x {{value}} diamonds! Double the credits, double the fun! You can use credits in <?php echo e($chocolatey->hotelName); ?> Hotel to purchase all sorts of amazing things, like furni, pets and even <?php echo e($chocolatey->hotelName); ?> Club memberships.",
  ...
  "USER_IDENTITY_PERMANENT_BAN_TEXT": "You have been permanently banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>.",
  ...
  "INTERS_INSTRUCTION": "Join <?php echo e($chocolatey->hotelName); ?> Club or Builders Club to play without adverts.",
  ...
  "CAMPAIGN_MESSAGES_TITLE": "Minimail from <?php echo e($chocolatey->hotelName); ?>",
  ...
  "MAINTENANCE_CONTENT": "Sorry! <?php echo e($chocolatey->hotelName); ?> is being worked on at the moment. We'll be back soon. We promise.",
  ...
  "ACCOUNT_SECURITY_PASSWORD_DESCRIPTION": "Please enter your current <?php echo e($chocolatey->hotelName); ?> password to save the settings.",
  ...
  "ERROR_SERVER_MAINTENANCE": "<?php echo e($chocolatey->hotelName); ?> is under a short maintenance break. We'll be back soon!",
  "LOCAL_REGISTER_BANNER_PT": "Entre na sua comunidade local em",
  "OPTOUT_SUCCESS": "Unsubscribe successful! You will no longer receive news about campaigns etc. from <?php echo e($chocolatey->hotelName); ?>.",
  "AVATAR_SELECTION_BANNED": "This avatar is banned from <?php echo e($chocolatey->hotelName); ?>.",
  ...
  "HOME_PAGE_FALLBACK_TITLE": "Looking for {{profileName}}'s <?php echo e($chocolatey->hotelName); ?> homepage?",
  ...
  "PLAYING_HABBO_HABBO_WAY_TAB": "<?php echo e($chocolatey->hotelName); ?> Way",
  ...
  "CLIENT_ERROR_TITLE": "Oh bobba, can't <?php echo e($chocolatey->hotelName); ?>!",
  "HOTEL_CLOSED_TITLE": "Hotel Closed",
  "LIKE": "Like",
  "NAVIGATION_PLAYING_HABBO": "Playing <?php echo e($chocolatey->hotelName); ?>",
  "FORCED_EMAIL_CHANGE_TEXT": "This email address has been reported as belonging to someone else. To access your <?php echo e($chocolatey->hotelName); ?> account, you need to change your login email.",
  "USER_AVATAR_BAN_TEXT": "Your avatar <b>{{avatarName}}</b> has been banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>.",
  "RELOAD_TITLE": "Disconnected!",
  "USER_IDENTITY_BAN_TEXT": "You have been banned from <?php echo e($chocolatey->hotelName); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>.",
  "SHOP_PAYMENT_PSMS_INSTRUCTIONS": "Instructions",
  "RSS_FEED_TITLE": "<?php echo e($chocolatey->hotelName); ?> News",
  ...
  "LOGIN_REGISTER": "Don't have an account? Join <?php echo e($chocolatey->hotelName); ?>!",
  ...
  "CONSOLE_WARNING": "Welcome to Chocolatey the ultimate experience with <?php echo e($chocolatey->hotelName); ?>WEB. We from Chocolatey team wish to you a good experience with it. Report bugs on our GitHub (https://github.com/sant0ro/Chocolatey).",
  ...
  "SHOP_TITLE": "Buy <?php echo e($chocolatey->hotelName); ?> credits and more",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_IT": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  "TX_HISTORY_DESCRIPTION_HTK_IR": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  "CREDITS_CASHCARDAU_PRICES_NOTE": "Please note that not all the stores carry <?php echo e($chocolatey->hotelName); ?> Prepaid Cards of all values, or the stores could be out of stock. To be sure, call your local store in advance.",
  "CREDITS_PURCHASE_OPTIONS_PREPAID_HEADER": "Prepaid",
  "CREDITS_CASHCARDAU_PRICES_SUBTITLE": "Australia:",
  "COINS_NAVI_SELECT_COUNTRY": "<?php echo e($chocolatey->hotelName); ?> Credits are the currency used in <?php echo e($chocolatey->hotelName); ?>. You can use them to buy all kinds of things, from rubber ducks and sofas, to HC membership and teleports.",
  "HEADING_HABBOCLUB_PUBLICROOM_ACCESS": "4. Access All Areas",
  "TX_HISTORY_DESCRIPTION_HTK_IE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  "CREDITOFFERS_DESCRIPTION": "Now you can collect <?php echo e($chocolatey->hotelName); ?> Credits by completing selected offers and surveys, here's how; <p/> <ol> <li>Select the amount of Credits you'd like to earn by clicking on an offer</li> <li>Follow the instructions on how to earn your Credits</li> <li>Keep track of when your Credits will be delivered by checking your status through 'Support' link on the Offer Wall below</li> <li>You will see the Credits in your <a href=\"history\" target=\"_blank\">Purse</a></li> </ol> <p/> ...and then have fun spending your <?php echo e($chocolatey->hotelName); ?> Credits!<p/>If you are missing Credits for completed offers, please contact the offer provider through the 'Support' link on the Offer Wall below.<br/><br/>",
  ...
  "CREDITS_SUBSCRIPTION_TEXT": "A Super Saver subscription lets you get the most out of your <?php echo e($chocolatey->hotelName); ?> experience:<br><ul><li>35 Credits to your account each and every month at a discount</li><li>A Gift Point that lets you get exclusive gifts only available to subscribers</li><li>One time sign up- no having to go through the process each month</li><li>Easy to join, easy to cancel with no hidden start up or cancellation charges</ul><p/><p/><?php echo e($chocolatey->hotelName); ?> - the ideal place to learn social skills, cooperation and money management in a safe and fun environment!",
  "TX_HISTORY_DESCRIPTION_SCRATCHCARDS_CA": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  "COLLECTIBLES_PURCHASE_TITLE": "Purchase Collectible",
  "PURSE_INFO_LOGIN_REQUIRED": "You need to log-in to see the purse",
  "CREDITS_PROMO_TEXT_2": "All legitimate ways to buy <?php echo e($chocolatey->hotelName); ?> Credits are to the left. Buying them elsewhere could get you ripped off and MAY get you banned.",
  "CREDITS_PROMO_TEXT_1": "<?php echo e($chocolatey->hotelName); ?> Credits are the currency used in <?php echo e($chocolatey->hotelName); ?>. You can use them to buy all kinds of things, from Rubber Ducks and Sofas, to HC membership and Teleports.",
  ...
  "TITLE_COINS": "Get virtual items, <?php echo e($chocolatey->hotelName); ?> Club membership and more with <?php echo e($chocolatey->hotelName); ?> Credits!",
  "TX_HISTORY_DESCRIPTION_DND": "Voucher Capades  dnD voucher redemption",
  "CREDITS_SUBSCRIPTION_CANCEL_TIME": "Canceled at:",
  "CREDITS_TOOLTIP_DESCRIPTION": "{0} <?php echo e($chocolatey->hotelName); ?> Credits allow you to purchase AWESOME things in <?php echo e($chocolatey->hotelName); ?>, like furni, pets and <?php echo e($chocolatey->hotelName); ?> Club memberships!",
  "CREDITS_CAMPAIGN_BANNER_BACKTOSCHOOL_BUY": "1 + 1 = 4? Double Credits for all!",
  "REDEEM_BUTTON_TEXT": "Redeem",
  "TX_HISTORY_DESCRIPTION_WORLDPAY": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Worldpay",
  "CREDITS_SUBSCRIPTION_ORDER_SUBMIT": "Continue",
  "HABBOCLUB_BUY_CONFIRM_BASIC_DAYS": "You are purchasing: <b>{0} days of <?php echo e($chocolatey->hotelName); ?> Club</b>",
  "TX_HISTORY_DESCRIPTION_BIBIT": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Credit Card",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_WIN_BTCELLNET": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "TITLE_COINS_PROMO": "What are <?php echo e($chocolatey->hotelName); ?> Credits?",
  "CREDITS_REGISTRATION_PURCHASE_HEADER": "Join <?php echo e($chocolatey->hotelName); ?> Club",
  ...
  "HABBOCLUB_STARTING_PRICE_NOTICE": "<?php echo e($chocolatey->hotelName); ?> Club membership starts from {0} Credits",
  "TX_HISTORY_DESCRIPTION_PREPAID_WALMART": "<?php echo e($chocolatey->hotelName); ?> prepaid card",
  ...
  "COINS_CASHCARDUS_INSTRUCTIONS2": "Buy a <?php echo e($chocolatey->hotelName); ?> Cash Card",
  ...
  "HABBO_ID_ERROR_USER_NOT_FOUND": "<?php echo e($chocolatey->hotelName); ?> with that name was not found",
  "CREDITS_REGISTRATION_CONTINUE": "Continue",
  "HABBOCLUB_BUY_SUCCESS_INFO_UPGRADE": "Your <?php echo e($chocolatey->hotelName); ?> Club subscription has been activated.",
  "CREDITS_CONFIRM_BRAINTREE_DETAILS_HEADER": "Credit Card Payment",
  "PIXELS_CONTENT_FAQ_LINK": "/help",
  "CREDITS_CASHCARDPH_PRICES_NOTE": "Please note that not all the stores carry <?php echo e($chocolatey->hotelName); ?> Scratch Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  "CREDITS_CAMPAIGN_BANNER_MONSTERPLANT_STATUS_PRE": "You have purchased",
  "TX_HISTORY_DESCRIPTION_SMS_MOB": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "TITLE_PURSE": "Purse",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSEAST_25": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "CREDITS_CASHCARDMY_INSTRUCTIONS2": "Buy a <?php echo e($chocolatey->hotelName); ?> Scratch Card",
  ...
  "CREDITS_CASHCARDUS_PRICES_SUBTITLE": "...and access to the most exciting <?php echo e($chocolatey->hotelName); ?> benefits, like HC and virtual furniture. Visit our Shop by entering <?php echo e($chocolatey->hotelName); ?> Hotel and clicking on the purse icon and see what Credits can get you.",
  ...
  "SUBSCRIPTION_CLOTHES_NOTICE_TITLE": "<?php echo e($chocolatey->hotelName); ?> Club purchase with clothes",
  ...
  "HABBOCLUB_STARTPRICE_UNAVAILABLE_NOTICE": "Not able to determine the <?php echo e($chocolatey->hotelName); ?> club price.",
  "TX_HISTORY_DESCRIPTION_HTK_DE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_ORANGE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_CASHCARDCA_PRICES_LIST": "<li><b>50</b> for <b>C$10</b></li> <li><b>125</b> for <b>C$25</b></li>",
  "HABBOCLUB_BUY_CONFIRM_VIP_BUY": "You are about to subscribe to <?php echo e($chocolatey->hotelName); ?> HC!",
  ...
  "TX_HISTORY_DESCRIPTION_CA_MONSTERS_PROMO_ 07": "Monsters of <?php echo e($chocolatey->hotelName); ?> (promotion)",
  ...
  "HABBOCLUB_BUY_HEADER_BASICCOL_INFO": "<?php echo e($chocolatey->hotelName); ?> Club",
  ...
  "CREDITOFFERS_DESCRIPTION_TITLE": "Collect <?php echo e($chocolatey->hotelName); ?> Credits",
  "CREDITS_CREDIT_OFFERS_TITLE": "Collect <?php echo e($chocolatey->hotelName); ?> Credits by completing special offers and surveys",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_VODAFONE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "TX_HISTORY_DESCRIPTION_PREPAID_AU": "Prepaid Card purchase",
  "COLLECTIBLES_BUTTON_REAUTHENTICATE": "Re-log in",
  "TX_HISTORY_DESCRIPTION_CLUB_HABBO": "<?php echo e($chocolatey->hotelName); ?> Club payment",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_BE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  "HABBOCLUB_BUY_NORMALHEADER_1": "1 month",
  "HABBOCLUB_BUY_SUCCESS_INFO_VIP_NEW": "Your <?php echo e($chocolatey->hotelName); ?> Club subscription has been activated.",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_BLACKHAWK": "<?php echo e($chocolatey->hotelName); ?> Prepaid Card redemption",
  "CREDITS_CATEGORY_QUICK_AND_EASY": "Quick and Easy",
  "CREDITS_CASHCARDMY_PRICES_NOTE": "Please note that not all the stores carry <?php echo e($chocolatey->hotelName); ?> Scratch Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  "TX_HISTORY_DESCRIPTION_OFFERS_SOMETRICS_US_SS": "Credit Offer",
  "CREDITS_SUCCESS_SUMMARY_BACK_TO_HABBO": "Back to <?php echo e($chocolatey->hotelName); ?>",
  "TX_HISTORY_DESCRIPTION_PREPAID_711_25": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "HABBOCLUB_BUY_CONFIRM_UPGRADE": "You are about to upgrade your existing <?php echo e($chocolatey->hotelName); ?> Club subscription. Cool! The upgrade will convert your remaining Club Subscription to HC based on the price difference between the subscriptions, and then give you {0} Credits worth of HC.",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSEAST": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_SG_45": "<?php echo e($chocolatey->hotelName); ?> prepaid card",
  "CREDITS_BRAINTREE_PROCESSED_BY": "Payment processed by",
  "HABBOCLUB_GIFTPOINTS": "Gift points left: {0}",
  "INFO_HABBOCLUB_UPGRADE_DISCLAIMER": "Disclaimer: 600 buddies do not come included with purchase of <?php echo e($chocolatey->hotelName); ?> Club.",
  ...
  "HABBOCLUB_BUY_GETCREDITSINFO": "Get some Credits and be part of <?php echo e($chocolatey->hotelName); ?> Club.",
  "CREDITS_CASHCARDSG_STORES_LIST": "Get collectable <?php echo e($chocolatey->hotelName); ?> Scratch Cards in comic/computer/book stores, as well as Comics Connection, Cheers and Esso Cheers outlets. Find a store near you with our <a href=\"http://promo.habbohotel.com.sg/storelocator/\">Store Locator</a>",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_WIN_VODAFONE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "INFO_HABBOCLUB_HEADERTEXT": "<?php echo e($chocolatey->hotelName); ?> Club is our HC members-only club - absolutely no riff-raff admitted! Members enjoy a wide range of benefits, including exclusive clothes, free gifts and an extended Friends List. See below for all the sparkly, attractive reasons to join.",
  ...
  "HABBOCLUB_BUY_CONFIRM_UPGRADE_DAYSNOW": "You now have: <b>{0} days of <?php echo e($chocolatey->hotelName); ?> Club</b>",
  ...
  "HABBO_ID_ERROR_NAME_REQUIRED": "Please enter <?php echo e($chocolatey->hotelName); ?> name",
  "CREDITS_CANCELED_HEADER": "Payment canceled",
  "CREDITS_HABBO_ID_CAPTION": "<?php echo e($chocolatey->hotelName); ?> ID for user",
  ...
  "HABBOCLUB_LOGINNEEDED": "Please sign in to see your <?php echo e($chocolatey->hotelName); ?> Club status",
  ...
  "COLLECTIBLES_DESCRIPTION_2009_1": "Found in frozen ice. This bizarre creature holds many secrets. Carbon dating revealed nothing helpful except its age: Very old. It makes you wonder what other dark secrets are hiding in the <?php echo e($chocolatey->hotelName); ?> oceans...",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_VODAFONE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "PURSE_BALANCE_AMOUNT": "{0} Credits",
  "TX_HISTORY_DESCRIPTION_SMS_MOBIE_METEOR": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "HABBOCLUB_BUY_SUCCESS_INFO_BASIC_EXTEND": "Your <?php echo e($chocolatey->hotelName); ?> Club subscription has been extended.",
  ...
  "COINS_CONFIRM_LISTING_RECIPIENT_HEADER": "<?php echo e($chocolatey->hotelName); ?> Name",
  ...
  "TX_HISTORY_DESCRIPTION_SCRATCHCARD_CA": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_NL": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_TMOBILE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_CAMPAIGN_BANNER_EASTERDOUBLE_BUY": "DOUBLE CREDITS AND EASTER RARE!",
  "CREDITS_TERMS_DESC": "Terms & Conditions apply",
  "NAVI_SHOW": "",
  "COINS_MOREINFO_LINK": "More info on <?php echo e($chocolatey->hotelName); ?> Credits",
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHAU": "Transfered from <?php echo e($chocolatey->hotelName); ?> Australia",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_INCOMM_AU": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "HABBO_ID_RESULT": "<?php echo e($chocolatey->hotelName); ?> account for user {1}: <b>{0}</b>",
  ...
  "HABBO_ID_FORM_NAME": "<?php echo e($chocolatey->hotelName); ?> name:",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_BILLING": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_BACKUP": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "TITLE_CREDITS_PROMO": "About <?php echo e($chocolatey->hotelName); ?> Credits",
  ...
  "TX_HISTORY_DESCRIPTION_PAYSAFE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Paysafe",
  ...
  "SUBSCRIPTION_CONFIRM_ONEMONTH": "{0} <?php echo e($chocolatey->hotelName); ?> Club month ({1} days) costs {2} Credits. You have: {3} Credits.",
  ...
  "CREDITS_REGISTRATION_PURCHASED_CONTINUE_HEADER": "Congrats! You are now a <?php echo e($chocolatey->hotelName); ?> Club member.",
  "SUBSCRIPTION_REAUTHENTICATE_LINK": "Go",
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHCA": "Transfered from <?php echo e($chocolatey->hotelName); ?> Canada",
  ...
  "CREDITS_MOREINFO_LINK": "More info on <?php echo e($chocolatey->hotelName); ?> Credits",
  "NAVI_CREDIT_OFFERS": "Earn Credits",
  "CREDITS_CAMPAIGN_BANNER_HABBOWEEN2012_TITLE": "Habboween has arrived!",
  "SUBSCRIPTION_CONFIRM_SEVERALMONTHS": "{0} <?php echo e($chocolatey->hotelName); ?> Club months ({1} days) costs {2} Credits. You have: {3} Credits.",
  "HABBO_ID_ID_FOR_USER": "The <?php echo e($chocolatey->hotelName); ?> ID number for",
  ...
  "SUBSCRIPTION_ACTIVE_BODY": "Now you'll be able to enjoy all the HC benefits of being a <?php echo e($chocolatey->hotelName); ?> Club member.",
  ...
  "CREDITS_CREDIT_OFFERS_HEADER": "Collect <?php echo e($chocolatey->hotelName); ?> Credits",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MOB_ORANGE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_O2": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_CAMPAIGN_BANNER_HABBOWEEN2012_TEXT": "Receive 5 Pumpkins for every 1 Credit you buy! Pumpkins are the ONLY way to get some of the latest <?php echo e($chocolatey->hotelName); ?>ween costumes and furni!",
  ...
  "CREDITS_DESCRIPTION": "<?php echo e($chocolatey->hotelName); ?> Credits",
  ...
  "CREDITS_CONFIRM_LISTING_RECIPIENT_HEADER": "<?php echo e($chocolatey->hotelName); ?> Name",
  ...
  "CREDITS_FAILURE_BACK_TO_HABBO": "Back to <?php echo e($chocolatey->hotelName); ?>",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_ORANGE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "CREDITS_CASHCARDSG_INSTRUCTIONS2": "Buy a <?php echo e($chocolatey->hotelName); ?> Scratch Card",
  ...
  "TX_HISTORY_DESCRIPTION_INCOMM_7ELEVEN_TEST": "<?php echo e($chocolatey->hotelName); ?> Prepaid Card redemption",
  ...
  "HABBOCLUB_BUY_GETCOINSINFO": "Get some Credits and be part of <?php echo e($chocolatey->hotelName); ?> Club.",
  "PURSE_COINS_AMOUNT_NEGATIVE": "Oh dear! There is something wrong with your purse.",
  "COINS_SAFETY_TEXT_1": "Always ask permission from your parent or guardian before you buy <?php echo e($chocolatey->hotelName); ?> Credits. If you do not do this and the payment is later canceled or declined, you will be permanently banned.",
  "HABBOCLUB_INSUFFIENT_COINS_NOTICE": "To join <?php echo e($chocolatey->hotelName); ?> Club you first need to buy some <?php echo e($chocolatey->hotelName); ?> Credits:",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_TEXT_ZONG": "If you do not receive permission to use this payment method and the payment is later canceled or declined, you will be banned. Please note that the charge on the phone bill may appear as \"Zong\", our partner in SMS billing. Please ensure that the bill payer recognizes \"Zong\" as your purchase of <?php echo e($chocolatey->hotelName); ?> Credits.",
  ...
  "CREDITS_NAVI_SELECT_COUNTRY": "<?php echo e($chocolatey->hotelName); ?> Credits are the currency used in <?php echo e($chocolatey->hotelName); ?>. You can use them to buy all kinds of things, from rubber ducks and sofas, to HC membership, and teleports.",
  "COINS_SAFETY_TEXT_2": "It is better to ask questions first, than be banned later ;)",
  "HABBOCLUB_BUY_CONFIRM_BASIC_BUY": "You are about to subscribe to <?php echo e($chocolatey->hotelName); ?> Club. Cool!",
  ...
  "COINS_SUCCESS_SUMMARY_BACK_TO_HABBO": "Back to <?php echo e($chocolatey->hotelName); ?>",
  "CREDITS_CASHCARDMY_STORES_TITLE": "",
  "HABBOCLUB_BUY_SUCCESS_INFO_VIP_EXTEND": "Your <?php echo e($chocolatey->hotelName); ?> Club subscription has been extended.",
  ...
  "HABBOCLUB_BUY_COINS_BUTTON": "Purchase <?php echo e($chocolatey->hotelName); ?> Credits",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_WIN_ORANGE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "COINS_SUCCESS_HEADER": "Congratulations!",
  "TX_HISTORY_DESCRIPTION_SMS_TMOBILE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_BUILDERS_CLUB_ACTIVE_TEXT": "Your subscription is active.",
  "TX_HISTORY_DESCRIPTION_PREPAID_BI_GET1": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  "COINS_FAILURE_INSTRUCTIONS": "Please go back and try the purchase again.",
  "CREDITS_TYPES_OTHER": "or",
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_3": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_HABBO_ID_NOT_LOGGED_IN": "Log in to see your <?php echo e($chocolatey->hotelName); ?> ID",
  ...
  "HABBOCLUB_BUY_HEADER_VIPCOL_INFO": "<?php echo e($chocolatey->hotelName); ?> Club",
  "PURSE_REDEEM_COINS_SUCCESS": "You received {0} Credits.",
  "COINS_EMBED_REDEEM_LOGIN_FIRST": "Please sign in first!",
  "HABBOCLUB_BUY_SUCCESS_INFO_BASIC_NEW": "Your <?php echo e($chocolatey->hotelName); ?> Club subscription has been activated.",
  "HABBOCLUB_CATALOG_NEXT": "Next",
  "REDEEM_INFO_REAUTHENTICATE": "Please reauthenticate to redeem a voucher.",
  "COINS_PROMO_TEXT_2": "Life is just more fun with <?php echo e($chocolatey->hotelName); ?> Credits.",
  ...
  "COINS_PROMO_TEXT_1": "<?php echo e($chocolatey->hotelName); ?> Credits are the currency used in <?php echo e($chocolatey->hotelName); ?>. You can use them to buy all kinds of things, from rubber ducks and sofas, to HC membership and teleports.",
  "NAVI_PIXELS": "Pixels",
  ...
  "COINS_CANCELED_BACK_TO_HABBO": "Back to <?php echo e($chocolatey->hotelName); ?>",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_V2_MERCHANT_INFO": "<?php echo e($chocolatey->hotelName); ?>-coins can be used on <?php echo e($chocolatey->hotelName); ?>",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_3": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_CVS": "<?php echo e($chocolatey->hotelName); ?> prepaid card from CVS",
  "PURSE_REDEEM_CODE_ALLREADY_REDEEMED": "Code has already been used.",
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSWEST_25": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_O2": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_ABTESTING_BOKU": "true",
  "FURNITRADE_HISTORY_TITLE_FROM": "Original Owner",
  "INFO_HABBOCLUB_UPGRADE_HOME": "Join <?php echo e($chocolatey->hotelName); ?> Club and say goodbye to homepage ads! And this means you can make the most of the HC skins and backgrounds too.",
  ...
  "HABBO_ID_FORM_ENTER_NAME": "Enter your <?php echo e($chocolatey->hotelName); ?> name below to see your ID number:",
  "PURSE_REDEEM_CREDITS_SUCCESS": "You received {0} Credits.",
  "FURNITRADE_HISTORY_TITLE_DATE": "Date",
  "TX_HISTORY_DESCRIPTION_DEFAULT": "<?php echo e($chocolatey->hotelName); ?> credit purchase",
  "TX_HISTORY_DESCRIPTION_HTK_UK": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  "INFO_HABBOCLUB_TRYOUT_LINK": "Try out <?php echo e($chocolatey->hotelName); ?> Club clothes for yourself!",
  "PIXELS_CONTENT_INFO_LI1": "1. Sign into <?php echo e($chocolatey->hotelName); ?> once a day",
  "TX_HISTORY_DESCRIPTION_XMAS_CAL_07": "Xmas Calendar 2007 (promotion)",
  "PIXELS_CONTENT_INFO_LI2": "2. Get rewarded for spending time each day in <?php echo e($chocolatey->hotelName); ?>- the longer you stay the more you earn!",
  ...
  "PIXELS_CONTENT_INFO_LI4": "4. Join <?php echo e($chocolatey->hotelName); ?> Club!",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_SINGLEDROP": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via land line",
  ...
  "CREDITOFFERS_TITLE_INFO": "Collect <?php echo e($chocolatey->hotelName); ?> Credits by completing special offers and surveys",
  "TX_HISTORY_DESCRIPTION_CA_MONSTERS_PROMO_07": "Monsters of <?php echo e($chocolatey->hotelName); ?> 2007 (promotion)",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MOB_3": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_CASHCARDAU_INSTRUCTIONS3": "Enter the code below",
  "TX_HISTORY_DESCRIPTION_SMS_WIN_TMOBILE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_CASHCARDAU_INSTRUCTIONS2": "Purchase your <?php echo e($chocolatey->hotelName); ?> Game Card",
  ...
  "HABBOCLUB_MEMBERSHIP_NO": "You are not a member of <?php echo e($chocolatey->hotelName); ?> Club",
  ...
  "CREDITS_CASHCARDPH_INSTRUCTIONS2": "Buy a <?php echo e($chocolatey->hotelName); ?> Scratch Card",
  ...
  "NAVI_HABBOCLUB_TRYOUT": "Join <?php echo e($chocolatey->hotelName); ?> Club!",
  "CREDITS_CASHCARDCA_PRICES_TITLE": "Prices",
  "CREDITS_LOYALTY_POINTS_HEADER": "Diamonds",
  "CREDITS_CANCELED_BACK_TO_HABBO": "Back to <?php echo e($chocolatey->hotelName); ?>",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_BHNCA": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_TEXT": "Please note that the charge on the credit card bill may appear as \"WorldPay\" our billing partner. Please ensure that the bill payer recognizes \"WorldPay\" as your purchase of <?php echo e($chocolatey->hotelName); ?> Credits.",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_INCOMM_UK": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  "PURSE_REDEEM_CODE_FAILED_UNKNOWN_TR_SYSTEM": "The code you entered {0} is not valid for <?php echo e($chocolatey->hotelName); ?>.com.  If you''re experiencing problems, please contact Customer Support.",
  "CREDITS_PENDING_SUMMARY_HEADER": "Please print this information for your reference",
  "TX_HISTORY_DESCRIPTION_SMS_MOBIE_VODAFONE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  "CREDITS_CAMPAIGN_BANNER_DIAMONDS2_BUY": "This weekend only, Get DOUBLE DIAMONDS!",
  "TX_HISTORY_DESCRIPTION_SMS_MOB_O2": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "HABBOCLUB_MEMBERSHIP_YES": "You are a member of <?php echo e($chocolatey->hotelName); ?> Club",
  "TX_HISTORY_DESCRIPTION_SMS_MOB_TMOBILE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MOB_VODAFONE": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSWEST": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  "TX_HISTORY_DESCRIPTION_PETRO_CA": "<?php echo e($chocolatey->hotelName); ?> eVoucher",
  "SUBSCRIPTION_ACTIVE_TITLE": "Your <?php echo e($chocolatey->hotelName); ?> Club membership is now activated.",
  ...
  "HABBOCLUB_BUY_CONFIRM_VIP_EXTEND": "You are about to extend your subscription to <?php echo e($chocolatey->hotelName); ?> Club. Glad to see you continue your subscription!",
  "CREDITS_BUTTON_SUBSCRIBE": "Subscribe",
  "TX_HISTORY_DESCRIPTION_AIR2WEB_CINGULAR": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Cingular PSMS",
  ...
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHUK": "Transfered from <?php echo e($chocolatey->hotelName); ?> UK",
  "PURSE_REDEEM": "Enter voucher code:",
  "TX_HISTORY_TITLE_AMOUNT": "Activity",
  "REDEEM_TEXT_BALANCE": "Balance:",
  "COINS_FAILURE_BACK_TO_HABBO": "Back to <?php echo e($chocolatey->hotelName); ?>",
  ...
  "COINS_CATEGORY_SUBSCRIPTION": "Get <?php echo e($chocolatey->hotelName); ?> Credits!",
  ...
  "CREDITS_SAFETY_TEXT_1": "Always ask permission from your parent or guardian before you buy <?php echo e($chocolatey->hotelName); ?> Credits. If you do not do this and the payment is later canceled or declined, you will be permanently banned.",
  "TX_HISTORY_DESCRIPTION_CREDITCARDS_IS_CA": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Credit Card",
  "HABBOCLUB_BUY_HEADER_INFOCOL_VIPSUB": "<?php echo e($chocolatey->hotelName); ?> Club",
  "CREDITS_BRAINTREE_FAILURE_MESSAGE_81725": "",
  "TX_HISTORY_NAVI_PREV": "Previous",
  "COINS_CASHCARDUS_PRICES_NOTE": "Please note that not all the stores carry <?php echo e($chocolatey->hotelName); ?> Prepaid Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  ...
  "TITLE_CREDITS": "Get <?php echo e($chocolatey->hotelName); ?> Credits!",
  "TX_HISTORY_DESCRIPTION_SMS_MOBIE_O2": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via SMS",
  ...
  "NAVI_HABBOCLUB": "VIP",
  "INFO_HABBOCLUB_ROOM_LAYOUT": "Special Guest Room layouts, only for <?php echo e($chocolatey->hotelName); ?> Club members. Perfect for showing off your new furni!",
  "CREDITS_CASHCARDPH_STORES_LIST": "Get collectable <?php echo e($chocolatey->hotelName); ?> Scratch Cards at Netopia, Excel, Compass Internet, Station 168/I-Hooked, and BeConnected Internet cafes. Also at Robinsons Departmental Stores now! Find a store near you with our <a href=\"http://promo.habbohotel.com.sg/storelocator/\">Store Locator</a>.",
  ...
  "TX_HISTORY_DESCRIPTION_SPLASHPLASTIC": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Splashplastic",
  "COINS_CASHCARDCA_STORES_LIST": "<table> <tr>",
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHSG": "Transfered from <?php echo e($chocolatey->hotelName); ?> Singapore",
  ...
  "HABBOCLUB_BUY_CONFIRM_BASIC_EXTEND": "You are about to extend your subscription to <?php echo e($chocolatey->hotelName); ?> Club. Glad to see you continue your subscription!",
  "HABBOCLUB_BUY_CREDITS_BUTTON": "Purchase <?php echo e($chocolatey->hotelName); ?> Credits",
  ...
  "HABBOCLUB_INSUFFIENT_CREDITS_NOTICE": "To join <?php echo e($chocolatey->hotelName); ?> Club you first need to buy some <?php echo e($chocolatey->hotelName); ?> Credits:",
  ...
  "SUBSCRIPTION_TITLE": "<?php echo e($chocolatey->hotelName); ?> CLUB",
  ...
  "CREDITS_PARENTS-GUIDE-TO-HABBO_LINK": "Parents' Guide to <?php echo e($chocolatey->hotelName); ?>",
  "TX_HISTORY_DESCRIPTION_FREECODES_NEWERA": "Bonus code",
  "CREDITS_CAMPAIGN_BANNER_LOYALTYBASIC_BUY": "Want More Credits, Rares, and <?php echo e($chocolatey->hotelName); ?> Club?",
  "TX_HISTORY_DESCRIPTION_INDIGO_CA": "<?php echo e($chocolatey->hotelName); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_UKASH_UK": "Buying <?php echo e($chocolatey->hotelName); ?> Credits via Ukash",
  "CREDITS_ABTESTING_ZONG": "true",
  "CREDITS_CONFIRM_BRAINTREE_BUTTON_LABEL": "Buy",
  "CREDITS_CASHCARDSG_PRICES_NOTE": "Please note that not all the stores carry <?php echo e($chocolatey->hotelName); ?> Scratch Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  "CREDITS_LOYALTY_POINTS_TITLE": "Your Loyalty Balance",
  "CREDITS_BRAINTREE_FAILURE_MESSAGE_81715": "Invalid credit card number",
  "INFO_HABBOCLUB_CLUBFURNI": "Once a month, every month, you'll be able to pick an exclusive piece of <?php echo e($chocolatey->hotelName); ?> Club furni.",
  ...
  "NAVIGATOR_FLATCATEGORY_GLOBAL_REVIEWS": "<?php echo e($chocolatey->hotelName); ?> Reviews",
  ...
  "NAVIGATOR_FLATCATEGORY_GLOBAL_LIFE": "<?php echo e($chocolatey->hotelName); ?> Life",
  "NAVIGATOR_FLATCATEGORY_GLOBAL_GAMES": "<?php echo e($chocolatey->hotelName); ?> Games",
  ...
  "MODERATOR_MSG_MUTE": "Your <?php echo e($chocolatey->hotelName); ?> has been muted until {0}.",
  "MODERATOR_MESSAGETEMPLATE_7": "If you need help with a problem  or you know a <?php echo e($chocolatey->hotelName); ?> who does, please visit our safety centre at https://www.habbo.com/playing-habbo/help .",
  ...
  "CFH_REASON_USELESS_TARGET": "Mods looked into the case and found that you have done nothing wrong. Sorry for the inconvenience, have a nice time playing <?php echo e($chocolatey->hotelName); ?>!",
  ...
  "SCAMMING_SEVERESTAFFIMPERSONATION": "Impersonating <?php echo e($chocolatey->hotelName); ?> staff with the intention of scamming is not permitted.",
  "DISRUPTION_FLOODING": "We want everyone to enjoy their time on <?php echo e($chocolatey->hotelName); ?>. Please keep the screen free from flooding.",
  "CFH_REASON_RECEIVED_REPORTER_SEXUALLY_INAPPROPIATE_BEHAVIOUR": "You have reported a user for sexually inappropiate behaviour. For your own safety, celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?> and keep personal information to yourself. Mods will take a look at this in the meantime.",
  ...
  "MODERATOR_MUTEWARNING_2": "Please don't let your <?php echo e($chocolatey->hotelName); ?> take part in sexually inappropiate behaviour.",
  "MODERATOR_MUTEWARNING_3": "We want everyone in <?php echo e($chocolatey->hotelName); ?> to have fun. Please stay clear from inappropriate or offensive chat.",
  "CFH_REASON_MEETING_IN_REAL_LIFE": "attempting to meet in real life",
  "MODERATOR_MUTEWARNING_4": "We want everyone to enjoy their time on <?php echo e($chocolatey->hotelName); ?>. Please help us by keeping the game disruption-free.",
  "MODERATOR_MUTEWARNING_5": "Scams are really bad for the whole community and can get your <?php echo e($chocolatey->hotelName); ?> in trouble.",
  ...
  "PII_HOMEADDRESS": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep personal information such as addresses  to yourself.",
  ...
  "MODERATOR_MSG_GUARDIAN": "<?php echo e($chocolatey->hotelName); ?> Guardians have voted to mute you until {0}",
  ...
  "MODERATOR_MESSAGETEMPLATE_12": "We understand that it's annoying when someone doesn't play fair, but trading and playing other <?php echo e($chocolatey->hotelName); ?>s' games is at your own risk. Please be careful.",
  ...
  "DISRUPTION_COMMERICALSPAM": "Please don't let your <?php echo e($chocolatey->hotelName); ?> spoil the fun for others  by spamming commercial advertising.",
  ...
  "MODERATOR_MESSAGETEMPLATE_17": "Unfortunately we can't read chatlogs in this language. Please just ignore the <?php echo e($chocolatey->hotelName); ?> who's annoying you, take them off  your friends list or go to another room.",
  ...
  "TERMSVIOLATION_OWNINGRETROHOTEL": "Clone  <?php echo e($chocolatey->hotelName); ?>s (Retros) can put the original hotel at risk. We suggest you keep it real.",
  "CFH_REASON_CYBERSEX_AUTO": "cybering",
  "TERMSVIOLATION_MINORSACCESSRESTRICTION": "You have to be 13 years or older to play <?php echo e($chocolatey->hotelName); ?>. If you are old enough to play <?php echo e($chocolatey->hotelName); ?>, please contact our Help Tool to appeal the ban.",
  ...
  "MODERATOR_MESSAGETEMPLATE_16": "We want you to feel safe and have fun in <?php echo e($chocolatey->hotelName); ?>. If you find yourself in an uncomfortable situation, clicking the H on the bottom left of your screen is a fast and easy way to get out.",
  ...
  "CFH_REASON_RECEIVED_REPORTER_MEETING_IN_REAL_LIFE": "You have reported a user  for wanting to meet in real life. For your own safety, celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?> and stay away from real life meetings. Mods will take a look at this in the meanwhile.",
  "CFH_REASON_RECEIVED_REPORTER_MINORS_ACCESS": "You have reported a user  for being too young to play <?php echo e($chocolatey->hotelName); ?>. Thanks for your message. Mods will take a look at this.",
  ...
  "CFH_REASON_MINORS_ACCESS": "being too young to play <?php echo e($chocolatey->hotelName); ?>",
  "SEXUALLYEXPLICIT_SEXLINKS": "Please keep your <?php echo e($chocolatey->hotelName); ?> away from offering and/or requesting sexually inappropriate websites.",
  ...
  "CFH_REASON_HELP_ACCOUNT_PAYMENT_ISSUES_AUTOREPLY": "Thanks for your message. Kindly submit a help ticket at <?php echo e($chocolatey->hotelName); ?> Customer Service and agents there will be happy to help!",
  "PII_NONSEXUALWEBCAM": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep personal information to yourself.",
  ...
  "SEXUALLYEXPLICIT_WEBCAMSEXNAKEDPICS": "Please keep your <?php echo e($chocolatey->hotelName); ?> away from offering or requesting sexually inappropriate images.",
  ...
  "CFH_REASON_HELP_AUTO_REPLY": "Thanks for your message. Kindly submit a help ticket at <?php echo e($chocolatey->hotelName); ?> Customer Service and agents there will be happy to help!",
  "CFH_REASON_RECEIVED_REPORTER_MEET_IRL": "You have reported a user  for wanting to meet in real life. For your own safety, celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?> and stay away from real life meetings. Mods will take a look at this in the meantime.",
  "CFH_REASON_SEXUALLY_INAPPROPIATE_BEHAVIOUR": "sexually inappropiate behaviour",
  "DISRUPTION_BLOCKING": "Your <?php echo e($chocolatey->hotelName); ?> is in the way! Blocking spoils the fun for everyone else.",
  "SEXUALLYEXPLICIT_PREDATORYBEHAVIOUR": "Please keep your <?php echo e($chocolatey->hotelName); ?> away from sexually inappropriate acts.",
  ...
  "MODERATOR_MSG_KICK": "Your <?php echo e($chocolatey->hotelName); ?> was kicked by a moderator.",
  "CFH_REASON_FLOODING": "flooding",
  "CFH_REASON_HELP_HABBO_AUTOREPLY": "Thanks for your message. Kindly submit a help ticket at <?php echo e($chocolatey->hotelName); ?> Customer Service and agents there will be happy to help!",
  ...
  "HARASSMENT_HACKINGTHREAT": "You wouldn't want your <?php echo e($chocolatey->hotelName); ?> to be hacked. Why threaten to do this to others.?",
  "HARASSMENT_PERSONALTHREATS": "We want everyone on <?php echo e($chocolatey->hotelName); ?> to feel safe. Physical or personal threats have no room on here.",
  "CFH_REASON_RESOLVED_REPORTER": "Thanks, mods looked into the issue for you and have taken appropriate action. Have a nice time playing <?php echo e($chocolatey->hotelName); ?>!",
  "CFH_REASON_ABUSIVE_TARGET": "Mods looked into the case and found there was nothing wrong in your act. Sorry for the wrong call, have a nice time playing <?php echo e($chocolatey->hotelName); ?>!",
  "CFH_REASON_CYBERSEX": "cybering",
  "CFH_REASON_RECEIVED_REPORTER_HABBO_NAME": "You have reported a user  for inappropriate <?php echo e($chocolatey->hotelName); ?> name. Thanks for your message. Mods will take a look at this.",
  ...
  "SCAMMING_CASINOSCAM": "We understand that it's annoying when someone doesn't play fair, but trading and playing other <?php echo e($chocolatey->hotelName); ?>s' games is at your own risk. Please be careful.",
  "HARASSMENT_BULLYING": "You wouldn't want your <?php echo e($chocolatey->hotelName); ?> to be bullied. Why do it to others?",
  "CFH_CLOSED_RESOLVED": "Thanks, mods looked into the issue for you and have taken appropriate action. Have a nice time playing <?php echo e($chocolatey->hotelName); ?>!",
  ...
  "PII_MAILADDRESSIMCONTACT": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep personal information such as IM and email to yourself.",
  ...
  "DISRUPTION_DOORBLOCKING": "We want everyone to have fun on here, so please move your <?php echo e($chocolatey->hotelName); ?> away from the door.",
  ...
  "MODERATOR_MSG_POSTFIX": "Reading through the <?php echo e($chocolatey->hotelName); ?> Way and Terms will help you avoid this issue in the future.",
  ...
  "SEXUALLYEXPLICIT_PROSTITUTION": "Please keep your <?php echo e($chocolatey->hotelName); ?> out of offering or requesting sexual acts in return for furni.",
  ...
  "INAPPROPRIATENAME_GROUPNAME": "Sorry, but your group name is not quite appropriate for <?php echo e($chocolatey->hotelName); ?>.",
  "MODERATOR_ROOMMESSAGETEMPLATE_1": "Your <?php echo e($chocolatey->hotelName); ?> is in the way! Blocking spoils the fun for everyone else.",
  "MODERATOR_ROOMMESSAGETEMPLATE_2": "This room is not appropriate for <?php echo e($chocolatey->hotelName); ?> and will shortly be closed. Anyone remaining will be automatically removed.",
  ...
  "SEXUALLYEXPLICIT_HARASSMENTRAPE": "Please  keep your <?php echo e($chocolatey->hotelName); ?> away from harrassing anyone sexually.",
  "CFH_REASON_HATE_SPEECH": "hate speech",
  "CFH_REASON_RECEIVED_REPORTER_HELP_ACCOUNT_PAYMENT_ISSUES": "Thanks for your message. Kindly submit a help ticket at <?php echo e($chocolatey->hotelName); ?> Customer Service and agents there will be happy to help!",
  ...
  "PII_PHONENUMBER": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep phone numbers to yourself and to not ask anyone for theirs.",
  "SEXUALLYEXPLICIT_MILDSEXUALTALK": "Please keep your <?php echo e($chocolatey->hotelName); ?> away from sexually themed chat.",
  ...
  "SCAMMING_MILDSTAFFIMPERSONATION": "Impersonating <?php echo e($chocolatey->hotelName); ?> staff with the intention of scamming is not permitted.",
  ...
  "INAPPROPRIATENAME_ROOMNAME": "Sorry, but your room/event name is not quite appropriate for <?php echo e($chocolatey->hotelName); ?>.",
  "CFH_REASON_RECEIVED_REPORTER_ASKING_PII": "You have reported a user for asking personal information. Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>! For your safety, it's best to keep personal information to yourself. Mods will take a look at this in the meantime.",
  "HARASSMENT_VIOLENTROLEPLAY": "Please don't let your <?php echo e($chocolatey->hotelName); ?> take part in violent role-play.",
  "CFH_REASON_SCAMSITES_PROMOTING": "promoting retros/scamsites",
  "MODERATOR_MSG_BAN": "Your <?php echo e($chocolatey->hotelName); ?> has been banned until {0}.",
  ...
  "PII_FULLNAMETOWNSCHOOL": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep personal information to yourself.",
  "TERMSVIOLATION_CHILDPORNOGRAPHY": "Offering or requesting illegal website links puts the whole <?php echo e($chocolatey->hotelName); ?> community at risk.",
  "TERMSVIOLATION_SELLINGHABBOACCOUNTFURNI": "The sale or purchase of <?php echo e($chocolatey->hotelName); ?>s accounts can put not only you, but the whole community at risk. And the sale or purchase of items for cash is not permitted either.",
  "CFH_REASON_SWEARING": "insults or offensive language",
  "INAPPROPRIATENAME_HABBONAME": "Sorry, but your <?php echo e($chocolatey->hotelName); ?> name is not quite appropriate for <?php echo e($chocolatey->hotelName); ?>.",
  "SEXUALLYEXPLICIT_CYBERSEX": "Please keep your <?php echo e($chocolatey->hotelName); ?> away from sexual role-play.",
  "MODERATOR_MSG_TRADINGLOCK": "You have been trade locked until {0}.",
  "PII_SOCIALMEDIACONTACTINFORMATION": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep personal information such as social media accounts to yourself.",
  "TERMSVIOLATION_CASINOROOMSLOCAL": "Please don't let your <?php echo e($chocolatey->hotelName); ?> place or accept bets. Show of your skills instead of leaving it up to chance!",
  "TERMSVIOLATION_DRUGPROMOTION": "The promotion of illegal activities puts the whole <?php echo e($chocolatey->hotelName); ?> community at risk.",
  ...
  "SCAMMING_STAFFIMPERSONATION": "<?php echo e($chocolatey->hotelName); ?> staff are unique, just like you. Please don't let your <?php echo e($chocolatey->hotelName); ?> impersonate them.",
  ...
  "HARASSMENT_OFFENDINGBEHAVIOUR": "We want everyone in <?php echo e($chocolatey->hotelName); ?> to have fun. Please stay clear from inappropriate or offensive chat.",
  ...
  "MODERATOR_MESSAGETEMPLATE_5": "No call for help needed here. Please just rate your <?php echo e($chocolatey->hotelName); ?> Helper at the end of each help session.",
  "CFH_REASON_RECEIVED_REPORTER_SEXUAL_WEBCAM_IMAGES": "You have reported a user for asking/offering sexual webcam or images. For your own safety, celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?> and keep personal information to yourself. Mods will take a look at this in the meantime.",
  ...
  "MODERATOR_MESSAGETEMPLATE_1": "Celebrate your anonymity on <?php echo e($chocolatey->hotelName); ?>. For your safety, it's best to keep personal information to yourself.",
  ...
  "RSS_URI": "<?php echo e($chocolatey->hotelUrl); ?>/rss.xml",
  "TWITTER_URI": "https://twitter.com/<?php echo e($chocolatey->twitter->username); ?>",
  "FACEBOOK_URI": "https://facebook.com/<?php echo e($chocolatey->facebook->page); ?>",
  "HOTEL_URI": "<?php echo e($chocolatey->hotelUrl); ?>/",
