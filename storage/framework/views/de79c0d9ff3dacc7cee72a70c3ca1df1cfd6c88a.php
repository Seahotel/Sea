...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e($chocolatey->hotelUrl); ?>/habbo-web/assets/css/maintenance.css">
    <script>
        !function () {
...
<div class="content">
    <div class="header">
        <div class="wrapper"><a href="<?php echo e($chocolatey->hotelUrl); ?>/" class="habbo-image"></a></div>
    </div>
    <div class="wrapper">
        <div class="page-content">
            <div class="main">
                <div class="box"><h1>Espreso not ready!</h1>
                    ...
                    <img style="float:right" src="<?php echo e($chocolatey->hotelUrl); ?>/habbo-web/assets/images/frank.gif"/>
                </div>
            </div>
        </div>
    </div>
